...
exports.aVestInput = exports.aVest = exports.aUserTotalDepositInput = exports.aUserTotalDeposit = exports.aUserInput = exports.aUser = exports.aProof = exports.aMPHInput = exports.aMPHHolderInput = exports.aMPHHolder = exports.aMPH = exports.aFundingInput = exports.aFunding = exports.aFunderTotalInterestInput = exports.aFunderTotalInterest = exports.aFunderInput = exports.aFunder = exports.aFractionalDepositInput = exports.aFractionalDeposit = exports.aDepositInput = exports.aDeposit = exports.aDPoolListInput = exports.aDPoolList = exports.aDPoolInput = exports.aDPool = void 0;
var aDPool = function (overrides) {
    return {
        ...
        users: overrides && overrides.hasOwnProperty('users') ? overrides.users : [exports.aUser()],
        ...
        deposits: overrides && overrides.hasOwnProperty('deposits') ? overrides.deposits : [exports.aDeposit()],
        ...
        funders: overrides && overrides.hasOwnProperty('funders') ? overrides.funders : [exports.aFunder()],
        ...
        fundings: overrides && overrides.hasOwnProperty('fundings') ? overrides.fundings : [exports.aFunding()],
        ...
        proof: overrides && overrides.hasOwnProperty('proof') ? overrides.proof : exports.aProof(),
    };
};
exports.aDPool = aDPool;
var aDPoolInput = function (overrides) {
    return {
...
exports.aDPoolInput = aDPoolInput;
var aDPoolList = function (overrides) {
    return {
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id : '5210ca75-fb0f-4815-a50b-f1c810375fac',
        pools: overrides && overrides.hasOwnProperty('pools') ? overrides.pools : [exports.aDPool()],
...
exports.aDPoolList = aDPoolList;
var aDPoolListInput = function (overrides) {
    return {
...
exports.aDPoolListInput = aDPoolListInput;
var aDeposit = function (overrides) {
    return {
        ...
        user: overrides && overrides.hasOwnProperty('user') ? overrides.user : exports.aUser(),
        UserID: overrides && overrides.hasOwnProperty('UserID') ? overrides.UserID : 'pariatur',
        pool: overrides && overrides.hasOwnProperty('pool') ? overrides.pool : exports.aDPool(),
...
exports.aDeposit = aDeposit;
var aDepositInput = function (overrides) {
    return {
...
exports.aDepositInput = aDepositInput;
var aFractionalDeposit = function (overrides) {
    return {
        ...
        active: overrides && overrides.hasOwnProperty('active') ? overrides.active : false,
        deposit: overrides && overrides.hasOwnProperty('deposit') ? overrides.deposit : exports.aDeposit(),
        DepositID: overrides && overrides.hasOwnProperty('DepositID') ? overrides.DepositID : 'maxime',
        proof: overrides && overrides.hasOwnProperty('proof') ? overrides.proof : exports.aProof(),
    };
};
exports.aFractionalDeposit = aFractionalDeposit;
var aFractionalDepositInput = function (overrides) {
    return {
...
exports.aFractionalDepositInput = aFractionalDepositInput;
var aFunder = function (overrides) {
    return {
        ...
        totalInterestByPool: overrides && overrides.hasOwnProperty('totalInterestByPool') ? overrides.totalInterestByPool : [exports.aFunderTotalInterest()],
...
exports.aFunder = aFunder;
var aFunderInput = function (overrides) {
    return {
...
exports.aFunderInput = aFunderInput;
var aFunderTotalInterest = function (overrides) {
    return {
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id : 'b25d5d3e-e19f-4616-aa20-99ad2faca70d',
        funder: overrides && overrides.hasOwnProperty('funder') ? overrides.funder : exports.aFunder(),
...
exports.aFunderTotalInterest = aFunderTotalInterest;
var aFunderTotalInterestInput = function (overrides) {
    return {
...
exports.aFunderTotalInterestInput = aFunderTotalInterestInput;
var aFunding = function (overrides) {
    return {
...
exports.aFunding = aFunding;
var aFundingInput = function (overrides) {
    return {
...
exports.aFundingInput = aFundingInput;
var aMPH = function (overrides) {
    return {
...
exports.aMPH = aMPH;
var aMPHHolder = function (overrides) {
    return {
...
exports.aMPHHolder = aMPHHolder;
var aMPHHolderInput = function (overrides) {
    return {
...
exports.aMPHHolderInput = aMPHHolderInput;
var aMPHInput = function (overrides) {
    return {
...
exports.aMPHInput = aMPHInput;
var aProof = function (overrides) {
    return {
...
exports.aProof = aProof;
var aUser = function (overrides) {
    return {
        ...
        totalDepositByPool: overrides && overrides.hasOwnProperty('totalDepositByPool') ? overrides.totalDepositByPool : [exports.aUserTotalDeposit()],
...
exports.aUser = aUser;
var aUserInput = function (overrides) {
    return {
...
exports.aUserInput = aUserInput;
var aUserTotalDeposit = function (overrides) {
    return {
...
exports.aUserTotalDeposit = aUserTotalDeposit;
var aUserTotalDepositInput = function (overrides) {
    return {
...
exports.aUserTotalDepositInput = aUserTotalDepositInput;
var aVest = function (overrides) {
    return {
...
exports.aVest = aVest;
var aVestInput = function (overrides) {
    return {
...
exports.aVestInput = aVestInput;
//# sourceMappingURL=generated-mocks.js.map