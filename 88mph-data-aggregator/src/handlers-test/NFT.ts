...
// import { NFT } from "../generated/contracts";
// import {
//   Deposit,
//   Funding,
//   DPool,
...
//       deposit.amount
//     );
//     fromUserTotalDepositEntity.totalHistoricalDeposit = fromUserTotalDepositEntity.totalHistoricalDeposit.minus(
//       deposit.amount
//     );
//     fromUserTotalDepositEntity.totalInterestEarned = fromUserTotalDepositEntity.totalInterestEarned.minus(
//       deposit.interestEarned
//     );
//     fromUserTotalDepositEntity.totalHistoricalInterestEarned = fromUserTotalDepositEntity.totalHistoricalInterestEarned.minus(
//       deposit.interestEarned
//     );
...
//     }
//     toUserTotalDepositEntity.totalActiveDeposit = toUserTotalDepositEntity.totalActiveDeposit.plus(
//       deposit.amount
//     );
//     toUserTotalDepositEntity.totalHistoricalDeposit = toUserTotalDepositEntity.totalHistoricalDeposit.plus(
//       deposit.amount
//     );
//     toUserTotalDepositEntity.totalInterestEarned = toUserTotalDepositEntity.totalInterestEarned.plus(
//       deposit.interestEarned
//     );
//     toUserTotalDepositEntity.totalHistoricalInterestEarned = toUserTotalDepositEntity.totalHistoricalInterestEarned.plus(
//       deposit.interestEarned
//     );
...
//     );
//     fromFunderTotalInterestEntity.totalHistoricalDeficitFunded = fromFunderTotalInterestEntity.totalHistoricalDeficitFunded.minus(
//       funding.fundedDeficitAmount
//     );
//     fromFunderTotalInterestEntity.totalRecordedFundedDepositAmount = fromFunderTotalInterestEntity.totalRecordedFundedDepositAmount.minus(
...
//     }
//     toFunderTotalInterestEntity.totalDeficitFunded = toFunderTotalInterestEntity.totalDeficitFunded.plus(
//       funding.fundedDeficitAmount
//     );
//     toFunderTotalInterestEntity.totalHistoricalDeficitFunded = toFunderTotalInterestEntity.totalHistoricalDeficitFunded.plus(
//       funding.fundedDeficitAmount
//     );
//     toFunderTotalInterestEntity.totalRecordedFundedDepositAmount = toFunderTotalInterestEntity.totalRecordedFundedDepositAmount.plus(
//       funding.recordedFundedDepositAmount
//     );
